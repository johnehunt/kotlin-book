...
abstract class AbstractAccount(
    ...
    val history: MutableList<Transaction> = mutableListOf<Transaction>()

    init {
        println("New Account created for $holder")
        count++
        balance = openingBalance
        history.add(DefaultTransaction(openingBalance))
    }
    ...
    override fun deposit(amount: Double): Transaction {
        ...
        balance += amount
        val transaction = DefaultTransaction(amount)
    ...
    override fun withdraw(amount: Double): Transaction {
        ...
        balance -= amount
        val transaction = DefaultTransaction(amount, "withdrawal")
        history.add(transaction)
        return transaction
    }
